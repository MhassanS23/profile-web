    ...
    return (
        <>
            ...
            <div className='flex h-screen justify-center gap-4 sm:flex-col md:flex-row'>
                ...
                <div className='lg:w-[40%]] relative flex h-full items-center justify-center self-end px-4 sm:w-full md:w-[50%]'>
                    ...
                    <div className='z-1 absolute relative bottom-0 self-end rounded-full sm:h-[17rem] sm:w-[17rem] md:h-[20rem] md:w-[20rem] lg:h-[30rem] lg:w-[30rem] xl:h-[32rem] xl:w-[32rem]'>
                        <Image
