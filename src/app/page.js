...
export default function Home() {
    return (
        <>
            ...
            <div className='mb-[1rem] mt-4 flex w-full flex-col items-center justify-center gap-2 rounded-xl bg-blue-1 text-white sm:h-[100%] sm:px-4 sm:py-4 lg:px-12 lg:py-2'>
                ...
                <div className='mb-[1rem] mt-2 flex w-full items-center text-white sm:flex-col sm:gap-4 lg:flex-row lg:gap-[5rem]'>
                    ...
                    <div className='flex flex-col gap-2 sm:w-[100%] sm:text-center lg:w-[60%] xl:w-[70%] lg:text-left'>
                        ...
                        <p className={`text-md mb-1 font-raleway font-medium text-white`}>
                            Hello, I am maulana graduate student from upn veteran university of east java. Currently, I am interested in frontend and backend website development.
                        </p>
                        <p className={`text-md mb-1 font-raleway font-medium text-white`}>
                            Have experience in developing web-based systems as part of the final project determining menu recommendations for promotions that were successfully implemented in an umkm shop. I am committed to developing a career in website development by following the development of technology in the future.
                        </p>
                        <p className={`text-md mb-1 font-raleway font-medium text-white`}>
                        ...
                        <div className='flex justify-center items-center flex-wrap gap-4'>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Html</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Css</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Javascript</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Bootstrap</p>
                            </div>
                            <div
                                className={`text-md flex cursor-pointer items-center justify-center gap-2 rounded-md bg-white px-2 py-2 font-raleway text-black shadow-lg shadow-md shadow-blue-2`}>
                                <RiTailwindCssFill  size={'1.5rem'} className='text-blue-2' />
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Tailwind</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Expressjs</p>
                            </div>
                            <div
                                className={`text-md flex cursor-pointer items-center justify-center gap-2 rounded-md bg-white px-2 py-2 font-raleway text-black shadow-lg shadow-md shadow-purple-1`}>
                                <FaReact size={'1.5rem'} className='text-blue-1' />
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>ReactJS</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>NextJS</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Chakra UI</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>Laravel</p>
                            </div>
                            <div
                                ...
                                <p className='lg:text-md font-bold sm:text-sm sm:hidden md:block'>PostgreSQL</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* <div className='mb-[1rem] mt-4 flex h-full w-full items-center justify-center gap-4 rounded-xl text-blue-1 sm:flex-col sm:px-4 sm:py-4 md:flex-row lg:px-12 lg:py-0'>
                <div>
                    ...
                    <div className='rounded shadow-lg shadow-purple-1'>
                        ...
                        <div className='flex w-full flex-col gap-2 px-6 pb-4 sm:text-justify lg:text-left'>
                            <div className='font raleway text-center text-lg font-bold text-black'>PT. Infra Solution</div>
                            ...
                            <div className='flex flex-row items-center gap-2'>
                                <p className='text-bold font-unbounded text-sm text-black'>Tech Stack:</p>
                                <div
            ...
            <div className='mb-[1rem] mt-6 flex h-full w-full sm:flex-col md:flex-row justify-center gap-4 sm:px-4 lg:px-12'>
                <div className='md:w-[50%]'>
                    <Header text={`Field Work Practice`} title={'PT. Infra Solution'} />
                    <div className='rounded shadow-lg shadow-purple-1'>
                        <Image
                            src='/pkl.jpg'
                            className='w-full sm:h-[10rem] lg:h-[15rem] rounded'
                            alt='Project 1'
                            width={420}
                            height={320}
                            quality={90}
                        ...
                        <div className='flex w-full flex-col gap-2 px-6 pb-4 sm:text-justify lg:text-left'>
                            ...
                            <p className={`text-md mb-1 text-center font-raleway font-medium text-black`}>
                                Developed a buying and selling system on the frontend. My job here is slicing pages with responsive and connecting several APIs.
                            </p>
                ...
                <div className='md:w-[50%]'>
                    ...
                    <div className='rounded shadow-lg shadow-purple-1'>
                        ...
                        <div className='flex w-full flex-col gap-2 px-6 pb-4 sm:text-justify lg:text-left'>
                            ...
                            <p className={`text-md text-center mb-1 font-raleway font-medium text-black`}>
                                Learn various tech stacks about fullstack on the frontend and backend. Here I know the fullstack world from teamwork to developing a system together.
                            </p>
                            <div className='flex flex-row flex-wrap justify-center items-center gap-2'>
                                ...
                                <div
                                    className={`text-md cursor-pointer rounded-full bg-white px-2 py-2 font-raleway text-black shadow-lg shadow-purple shadow-purple`}>
            ...
            <div className='sm:mb-[2rem] sm:mt-6 md:mb-[1rem] md:mt-2 flex sm:h-full lg:h-screen w-full flex-col items-center justify-center gap-4 sm:px-4 lg:px-12'>
                <TabProject />
            </div>
